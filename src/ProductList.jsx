                ...
                <div style={styleObjUl}>
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            ...
                            <text x="90" y="155" font-size="90" fill="white">{calculateTotalQuantity()}</text></svg></h1>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => ( 
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button className={`product-button ${cart.some(item => item.name === plant.name) ? 'added-to-cart' : ''}`}
                                            onClick={() => handleAddToCart(plant)}
                                            diabled={cart.some(item => item.name === plant.name)}
                                        >
